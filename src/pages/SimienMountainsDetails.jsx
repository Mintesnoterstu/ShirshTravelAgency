...
const SimienMountainsDetails = () => {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        background: `linear-gradient(rgba(139, 69, 19, 0.5), rgba(205, 133, 63, 0.5)), url('https://simienpark.org/wp-content/uploads/2017/10/simien-landscape-small.jpg')`,
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: currentTheme.primary, fontSize: '1.8rem', marginBottom: '1rem' }}>The Roof of Africa Awaits</h2>
        <div style={{ 
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: currentTheme.primary, fontSize: '1.8rem', marginBottom: '1rem' }}>✨ Top Experiences in the Simien Mountains</h2>
        
        <div style={{ marginBottom: '2rem' }}>
          <h3 style={{ color: currentTheme.primary, fontSize: '1.4rem', marginBottom: '1rem' }}>1. Trekking Through Cloud Kingdoms</h3>
          <div style={{ 
            background: currentTheme.surface, 
            padding: '1.5rem', 
            borderRadius: '10px',
        ...
        <div style={{ marginBottom: '2rem' }}>
          <h3 style={{ color: currentTheme.primary, fontSize: '1.4rem', marginBottom: '1rem' }}>2. Wildlife Encounters You Can't Find Elsewhere</h3>
          <div style={{ 
            background: currentTheme.surface, 
            padding: '1.5rem', 
            borderRadius: '10px',
        ...
        <div style={{ marginBottom: '2rem' }}>
          <h3 style={{ color: currentTheme.primary, fontSize: '1.4rem', marginBottom: '1rem' }}>3. Cultural Connections</h3>
          <div style={{ 
            background: currentTheme.surface, 
            padding: '1.5rem', 
            borderRadius: '10px',
        ...
        <div style={{ marginBottom: '2rem' }}>
          <h3 style={{ color: currentTheme.primary, fontSize: '1.4rem', marginBottom: '1rem' }}>4. Jaw-Dropping Viewpoints</h3>
          <div style={{ 
            background: currentTheme.surface, 
            padding: '1.5rem', 
            borderRadius: '10px',
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: currentTheme.primary, fontSize: '1.8rem', marginBottom: '1rem' }}>🌍 Why the Simiens Belong on Your Bucket List</h2>
        <div style={{ 
          background: currentTheme.surface, 
          padding: '1.5rem', 
          borderRadius: '10px',
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            ...
            <li style={{ marginBottom: '0.8rem', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: currentTheme.accent, marginRight: '10px', fontSize: '1.2rem' }}>✔</span>
              <div style={{ color: currentTheme.text }}>
                <strong>Endemic Wildlife</strong> – See animals found nowhere else on Earth.
              </div>
            </li>
            <li style={{ marginBottom: '0.8rem', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: currentTheme.accent, marginRight: '10px', fontSize: '1.2rem' }}>✔</span>
              <div style={{ color: currentTheme.text }}>
                <strong>Adventure of a Lifetime</strong> – Trekking routes for all fitness levels.
              </div>
            </li>
            <li style={{ marginBottom: '0.8rem', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: currentTheme.accent, marginRight: '10px', fontSize: '1.2rem' }}>✔</span>
              <div style={{ color: currentTheme.text }}>
                <strong>Cultural Immersion</strong> – Connect with local communities and traditions.
              </div>
            </li>
          </ul>
        </div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <p style={{ color: currentTheme.text }}>October–March (dry season). Avoid July–August rains.</p>
          </div>
          <div>
            <h3 style={{ color: currentTheme.primary, marginBottom: '0.5rem' }}>🏔️ Trekking Tips</h3>
            <ul style={{ margin: 0, paddingLeft: '1.5rem', color: currentTheme.text }}>
              <li><strong>Acclimatization</strong>: Spend 1-2 days in Gondar before trekking.</li>
              <li><strong>Guides Required</strong>: Park regulations mandate local guides.</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ padding: '1rem', background: currentTheme.surface, borderRadius: '8px' }}>
              ...
              <p style={{ color: currentTheme.text }}>Sankaber to Chenek, wildlife viewing</p>
            </div>
            <div style={{ padding: '1rem', background: currentTheme.surface, borderRadius: '8px' }}>
              <h4 style={{ color: currentTheme.primary, marginBottom: '0.5rem' }}><strong>5 Days</strong></h4>
              <p style={{ color: currentTheme.text }}>Geech to Imet Gogo, village visits</p>
            </div>
            <div style={{ padding: '1rem', background: currentTheme.surface, borderRadius: '8px' }}>
              <h4 style={{ color: currentTheme.primary, marginBottom: '0.5rem' }}><strong>10 Days</strong></h4>
              <p style={{ color: currentTheme.text }}>Ras Dashen summit expedition</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <h2 style={{ marginBottom: '1rem' }}>🏔️ Ready to Conquer the Roof of Africa?</h2>
        <p style={{ fontSize: '1.1rem', marginBottom: '1rem' }}>
          <em>Let Shirsh Travel Agency guide you through Ethiopia's most spectacular mountain adventure.</em>
        </p>
