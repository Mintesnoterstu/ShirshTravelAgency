        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
          <div>
            ...
            <section style={{ background: 'white', padding: '2rem', borderRadius: '15px', marginBottom: '2rem', boxShadow: '0 4px 16px rgba(0,0,0,0.1)' }}>
              <h2 style={{ color: '#1e3c72', fontSize: '2rem', marginBottom: '1rem' }}>Historical Context</h2>
              <p style={{ fontSize: '1.1rem', lineHeight: 1.7, color: '#333' }}>
                Capital of the ancient Axumite Kingdom (1st-7th century AD), once a major trading power rivaling Rome and Persia. Believed by many to house the Ark of the Covenant.
              </p>
            </section>
            ...
            <section style={{ background: 'white', padding: '2rem', borderRadius: '15px', marginBottom: '2rem', boxShadow: '0 4px 16px rgba(0,0,0,0.1)' }}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <ul style={{ fontSize: '1.1rem', lineHeight: 1.7, color: '#333', paddingLeft: '1.5rem' }}>
                  ...
                  <li>The 24m Great Stele (the largest fallen obelisk)</li>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <ul style={{ fontSize: '1.1rem', lineHeight: 1.7, color: '#333', paddingLeft: '1.5rem' }}>
                  ...
                  <li>King Ezana's Inscription (in Sabaean, Greek and Ge'ez)</li>
            ...
            {/* Cultural Insights */}
            <section style={{ background: 'white', padding: '2rem', borderRadius: '15px', marginBottom: '2rem', boxShadow: '0 4px 16px rgba(0,0,0,0.1)' }}>
              <h2 style={{ color: '#1e3c72', fontSize: '2rem', marginBottom: '1rem' }}>Cultural Insights</h2>
          ...
          <div>
            ...
            {/* Travel Tips */}
            <section style={{ background: 'white', padding: '2rem', borderRadius: '15px', marginBottom: '2rem', boxShadow: '0 4px 16px rgba(0,0,0,0.1)' }}>
              <h2 style={{ color: '#1e3c72', fontSize: '1.5rem', marginBottom: '1rem' }}>Travel Tips</h2>
